...
export function Cpu(props: PropsType) {
  return (
    <svg
    ...
    >
      <path
        fill="currentColor"
        d="M9.75 4a.75.75 0 01.75.75V6h3V4.75a.75.75 0 011.5 0V6h1.25a2.75 2.75 0 012.75 2.75V10h1.25a.75.75 0 010 1.5H19v3h1.25a.75.75 0 010 1.5H19v1.25a2.75 2.75 0 01-2.75 2.75H15v1.25a.75.75 0 01-1.5 0V19h-3v1.25a.75.75 0 01-1.5 0V19H7.75A2.75 2.75 0 015 16.25V15H3.75a.75.75 0 010-1.5H5v-3H3.75a.75.75 0 010-1.5H5V8.75A2.75 2.75 0 017.75 6H9V4.75A.75.75 0 019.75 4zM7.5 8.75v6.5c0 .69.56 1.25 1.25 1.25h6.5c.69 0 1.25-.56 1.25-1.25v-6.5c0-.69-.56-1.25-1.25-1.25h-6.5c-.69 0-1.25.56-1.25 1.25zm3.25.75h2.5c.414 0 .75.336.75.75v2.5a.75.75 0 01-.75.75h-2.5a.75.75 0 01-.75-.75v-2.5c0-.414.336-.75.75-.75z"
      />
    </svg>
  );
}
...
export function BookOpen(props: PropsType) {
  return (
    ...
    >
      <path
        fill="currentColor"
        d="M12 5.25c-2.28-1.118-5.03-1.57-8-.5a.75.75 0 00-.5.707v13.086a.75.75 0 00.973.708c2.698-.867 5.447-.558 7.527.5a.75.75 0 00.667 0c2.08-1.058 4.829-1.367 7.527-.5a.75.75 0 00.973-.708V5.457a.75.75 0 00-.5-.707c-2.97-1.07-5.72-.618-8 .5zm-.75 12.657c-1.953-.755-4.225-.925-6.5-.407V6.168c2.23-.63 4.47-.545 6.5.4v11.34zm1.5 0v-11.34c2.03-.945 4.27-1.03 6.5-.4v11.332c-2.275-.518-4.547-.348-6.5.408z"
      />
    </svg>
  );
}
...
export function Mail(props: PropsType) {
  return (
    ...
    >
      <path
        fill="currentColor"
        d="M3 4.75A2.75 2.75 0 00.25 7.5v9A2.75 2.75 0 003 19.25h18A2.75 2.75 0 0023.75 16.5v-9A2.75 2.75 0 0021 4.75H3zm0 1.5h18c.138 0 .27.028.388.079L12 12.95 2.612 6.329A1.25 1.25 0 013 6.25zm-.75 2.238l7.823 5.435a1.75 1.75 0 001.854 0l7.823-5.435V16.5c0 .69-.56 1.25-1.25 1.25H3c-.69 0-1.25-.56-1.25-1.25V8.488z"
      />
    </svg>
  );
}
